...
export interface ImportSpecialPlates {
  ...
  file: string
  active: string
  checkpoints: { value: any; label: string }[];
...
export interface SuspectPeopleResponse {
  statusCode: number;
  status: string;
  success: boolean;
  message: string;
...
export interface SuspectPeopleCreateResponse {
  statusCode: number;
  status: string;
  success: boolean;
  message: string;
...
export interface WatchListFileResponse {
  statusCode: number;
  status: string;
  success: boolean;
  message: string;
