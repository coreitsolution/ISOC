  ...
  const convertedData = useMemo(() => {
    ...
    return textsDataList.map((data) => {
      ...
      return {
        ...
        cannotImport: !region || !plateType || !status || data.checkpoints.length === 0
      }
    })
            ...
            <Table stickyHeader>
              ...
              >
                <TableRow>
                  ...
                  <TableCell>{t('table.column.destination-checkpoint')}</TableCell>
                  ...
                  confirmationData.map((data, index) => {
                    ...
                    return (
                      <TableRow key={index} className="relative" sx={{ opacity: data.cannotImport ? 0.8 : 1 }}>
                        ...
                        <TableCell sx={{ backgroundColor: "#48494B", textAlign: "center" }}>{data.checkpoints.map(c => c.label).join(", ")}</TableCell>
